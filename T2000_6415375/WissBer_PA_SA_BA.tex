...
\newcommand{\titel}{Entwicklung einer Überwachungs- und Diagnose-Applikation für das Kommunikationsprotokoll zwischen den Teilmaschinen im Linienverbund}
\newcommand{\untertitel}{}	% ggf. Untertitel mit ergänzenden Hinweisen
\newcommand{\arbeit}{Projektarbeit T4\lowrule 2000}
...
\newcommand{\autor}{Fabian Wiedemann}
\newcommand{\abgabedatum}{07.09.2026}  % oder \newcommand{\abgabedatum}{\today}; Abgaben dürfen auch vor Fristende erfolgen, sofern der erforderliche Workload geleistet wurde
\newcommand{\bearbeitungszeitraum}{30.03.2026 - 07.09.2026}
\newcommand{\matrikelnr}{6415375}
\newcommand{\kurs}{TEA24}
\newcommand{\firma}{MULTIVAC Sepp Haggenmüller SE \& Co.KG}
\newcommand{\betreuerfirma}{M. Eng. Dipl.-Ing.(FH) Markus Bachmann}
...
style=authoryear, %% Zitierstil (siehe Dokumentation) style=numeric oder style=alphabetic oder authortitle oder authoryear
%verbose-inote,
...
\addbibresource{literature/T2000.bib}
...
\include{chapter/unternehmens_projektumfeld}
\include{chapter/grundlagen}
\include{chapter/Ausgangssituation}
\include{chapter/TechnischeRahmenbedingungen}
\include{chapter/Technischeskonzept}
\include{chapter/Umsetzung1}
\include{chapter/TestkonzeptundTests}
\include{chapter/BewertungundErgebnis}
\include{chapter/FazitundAusblick}
