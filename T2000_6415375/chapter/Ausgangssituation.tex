...
\section{Monitoring über MQTT.fx}
    ...
    \subsection{Funktionalität von MQTT.fx}
        ...
        Neben dem Reiter Publish gibt es auch einen Subscribe-Reiter, der in Listing \ref{fig:mqttfx_subscribe} dargestellt ist. Hier können einzelne Topics oder Topic-Hierarchien abonniert werden.
