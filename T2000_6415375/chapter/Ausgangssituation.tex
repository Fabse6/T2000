...
\section{Möglichkeit der Nutzung und Erweiterung bereits existenter Applikationen}
    Eine weitere Möglichkeit neben der Verwendung von bereits fertigen Programmen ist die Weiterentwicklung existenter Applikationen, die den Programmcode veröffentlichen. Eine hierfür besonders geeignete Applikation ist MQTTMultimeter. Da der Quellcode con MQTTMultimeter öffentlich verfügbar ist, konnten zentrale Komponenten der Anwendung analysiert und hinsichtlich ihrer Erweiterbarkeit bewertet werden. Die Analyse basiert auf dem auf GitHub veröffentlichten Projektstand \autocite{zotero-item-198}.
...
\begin{table}[htbp] 
    ...
    \begin{tabular}{lccccc} 
        ...
        \midrule Persistente Speicherung & 25\% & 0 & 0 & 3 \\ 
        Volltextsuche & 15\% & 0 & 5 & 5 \\ 
        Erweiterbarkeit & 20\% & 1 & 1 & 3 \\ 
        Simulationsmöglichkeiten & 10\% & 5 & 4 & 5 \\ 
        Performance & 15\% & 4 & 4 & 2 \\ 
        Benutzerfreundlichkeit & 15\% & 3 & 5 & 3 \\ 
        \midrule Gesamt & 100\% & 2,0 & 2,9 & 3,4 \\ 
        \bottomrule 
    \end{tabular} 
\end{table}
