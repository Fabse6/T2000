...
\section{Anforderungen an die Programmiersprache}
    ...
    \subsection{MQTT-Client-Bibliothek}
        ...
        Framework automatisch aufgerufen werden, sobald ein Ereignis eintritt \autocite{PollingCallbackThere}. Dadurch können nach dem Abonnieren von Topics empfangene Nachrichten ereignisbasiert 
        ...
        Im Gegensatz zum ständigen abfragen auf neue Nachrichten, auch Polling genannt, wird die CPU nur beim Eintreffen neuer Nachrichten belastet \autocite{PollingCallbackThere}. 
