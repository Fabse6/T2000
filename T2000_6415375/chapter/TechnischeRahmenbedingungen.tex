...
\section{Anforderungen an die Programmiersprache}
    ...
    \subsection{Eignung der Sprache C\# für die Umsetzung}
       Für die Umsetzung der Applikation eignet sich insbesondere die Programmiersprache C\#. Sie bietet die Möglichkeit, Ereignisse asynchron zu verarbeiten, was bei großen Datenmengen eine entscheidende Rolle spielt. 
        ...
        Für die Realisierung der Monitoring- und Diagnose-Software fällt die Wahl daher auf C\#. Die Programmiersprache bietet die erforderliche Flexibilität und Performanz für die Verarbeitung der Anwendungsdaten.
    ...
    \subsection{MQTT-Client-Bibliothek}
        ...
        Diese geforderten Funktionen können durch die Bibliothek \textit{MQTTnet} durch wenige Zeilen Programmcode vereinfacht in C\# umgesetzt werden \autocite[]{teamHowUseMQTT}. 
        Des Weiteren lassen sich durch die Bibliothek auch Ereignis- und Callback-Mechanismen über Event-Handler implementieren. Callbacks sind registrierte Rückruffunktionen, die vom System oder
        Framework automatisch aufgerufen werden, sobald ein Ereignis eintritt \autocite[23]{callback}. Dadurch können nach dem Abonnieren von Topics empfangene Nachrichten ereignisbasiert 
        ...
        Studien zum Vergleich von Push- und Pull-Verfahren zeigen, dass Push-basierte Ansätze wie Callbacks hinsichtlich Latenz und Skalierbarkeit Vorteile gegenüber Polling aufweisen, insbesondere bei einer hohen Anzahl von Clients oder Ereignissen \autocite{vyvereComparingPollingPushbased2020}. 
    ...
    \subsection{Graphical User Interface Framework}
        Aus den bereits vorgestellten Applikationen können einige Anforderungen an die grafische Oberfläche herausgefiltert werden. Für die Umsetzung einer Monitoring- und Visualisierungsapplikation muss das \acrshort{acr:GUI}-Framework ein ereignisgesteuertes Modell mit einer
        ...
        Durch ein integriertes Event-System sowie einen zentralen Eventloop eignet sich WPF besonders für ereignisgesteuerte Anwendungen \autocite{XAMLMitWPF}.
        Zudem bietet das Framework eine umfangreiche Unterstützung für Datenbindung \autocite[7]{wegenerWPF45Und2012}, Styles sowie das MVVM-Architekturmuster, wodurch datengetriebene Benutzeroberflächen
...
\section{Anforderungen an die Test- und Entwicklungsumgebung}
    ...
    \subsection{Testumgebung}
        ...
        Es stellt sich also heraus, dass selbst erstellte Testumgebungen für realitätsnahe Tests nicht ausreichen. Durch das fehlen von Simulationsmöglichkeiten durch andere Applikationen können Abläufe mit realen Topics und Nachrichtenlasten nicht nachgebaut werden. Deswegen muss eine Verpackungslinie für Testdurchführungen genutzt werden, die durch eine möglichst große Anzahl an Teilnehmern und eingebauten Automatisierungsabläufen eine möglichst hohe Nachrichtenfrequenz bereitstellt.
